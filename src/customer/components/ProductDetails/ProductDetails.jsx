        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              ...
              <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt1'>Casual Puff Sleeves Solid Women White Top</h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <Button onClick={handleAddToCart} variant='contained' sx={{ px: "2rem", py: "1rem", bgcolor: "#9155fd", fontWeight: "bold", mt: "1rem" }}
                >
                  Add To Cart
                </Button>
              </form>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-60'>549789 Rating</p>
                </div>
                <Box className="mt-5">
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} variant="determinate" value={60} color='info' />
                    </Grid>
                  </Grid>
